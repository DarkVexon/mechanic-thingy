...
public class ModFile implements
    ...
    public ModFile() {
        ...
        BaseMod.addColor(CharacterFile.Enums.VEX_MECHANIC_COLOR, characterColor, characterColor, characterColor,
    ...
    public void receiveEditCharacters() {
        BaseMod.addCharacter(new CharacterFile(CharacterFile.characterStrings.NAMES[1], CharacterFile.Enums.THE_VEX_MECHANIC),
                CHARSELECT_BUTTON, CHARSELECT_PORTRAIT, CharacterFile.Enums.THE_VEX_MECHANIC);
    }
    ...
    public void receiveEditCards() {
        CustomIconHelper.addCustomIcon(TicketIcon.get());
